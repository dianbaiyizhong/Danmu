...
<div class="btn-toolbar">
    <button class="btn btn-primary" onclick="window.open('register.aspx','_parent')"><i class="icon-plus"></i> 添加新用户</button>
      ...
      <tbody>
       <% foreach (var item in list)
        ...
        <tr>
          ...
          <td>
              <a href="editUser.aspx?id=<%=item.Id %>"><i class="icon-pencil"></i></a>
